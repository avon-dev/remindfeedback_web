...
export const GETFEEDBACK_CATEGORY_READ_SUCCESS =
  "GETFEEDBACK_CATEGORY_READ_SUCCESS"; // GET 피드백 카테고리 READ 성공
export const GETFEEDBACK_CATEGORY_READ_FAILURE =
  "GETFEEDBACK_CATEGORY_READ_FAILURE"; // GET 피드백 카테고리 READ 실패
...
export const FEEDBACK_ITEM_COMPLETE_REQ_REQUEST =
  "FEEDBACK_ITEM_COMPLETE_REQUEST"; // 피드백 게시물 완료 시도 중
export const FEEDBACK_ITEM_COMPLETE_REQ_SUCCESS =
  "FEEDBACK_ITEM_COMPLETE_SUCCESS"; // 피드백 게시물 완료 성공
export const FEEDBACK_ITEM_COMPLETE_REQ_FAILURE =
  "FEEDBACK_ITEM_COMPLETE_FAILURE"; // 피드백 게시물 완료 실패
...
export const FEEDBACK_ITEM_COMMENT_ADD_REQUEST =
  "FEEDBACK_ITEM_COMMENT_ADD_REQUEST"; // 피드백 게시물 댓글 ADD 시도 중
export const FEEDBACK_ITEM_COMMENT_ADD_SUCCESS =
  "FEEDBACK_ITEM_COMMENT_ADD_SUCCESS"; // 피드백 게시물 댓글 ADD 성공
export const FEEDBACK_ITEM_COMMENT_ADD_FAILURE =
  "FEEDBACK_ITEM_COMMENT_ADD_FAILURE"; // 피드백 게시물 댓글 ADD 실패

export const FEEDBACK_ITEM_COMMENT_UPDATE_REQUEST =
  "FEEDBACK_ITEM_COMMENT_UPDATE_REQUEST"; // 피드백 게시물 댓글 Update 시도 중
export const FEEDBACK_ITEM_COMMENT_UPDATE_SUCCESS =
  "FEEDBACK_ITEM_COMMENT_UPDATE_SUCCESS"; // 피드백 게시물 댓글 Update 성공
export const FEEDBACK_ITEM_COMMENT_UPDATE_FAILURE =
  "FEEDBACK_ITEM_COMMENT_UPDATE_FAILURE"; // 피드백 게시물 댓글 Update 실패

export const FEEDBACK_ITEM_COMMENT_DELETE_REQUEST =
  "FEEDBACK_ITEM_COMMENT_DELETE_REQUEST"; // 피드백 게시물 댓글 DELETE 시도 중
export const FEEDBACK_ITEM_COMMENT_DELETE_SUCCESS =
  "FEEDBACK_ITEM_COMMENT_DELETE_SUCCESS"; // 피드백 게시물 댓글 DELETE 성공
export const FEEDBACK_ITEM_COMMENT_DELETE_FAILURE =
  "FEEDBACK_ITEM_COMMENT_DELETE_FAILURE"; // 피드백 게시물 댓글 DELETE 실패
  ...
  switch (action.type) {
    ...
    case GETFEEDBACK_CATEGORY_READ_SUCCESS:
      return {
        ...
        isLoadedGetFeedbackCategory: false,
        isLoadedGetFeedbackCategory: true,
        getFeedbackCategory: action.data.success
          ? action.data.data
          : state.getFeedbackCategory
      };
    ...
    case FEEDBACK_ADD_SUCCESS:
      ...
      return {
        ...
        feedback: {
          ...state.feedback,
          myFeedback: [addedFeedback, ...state.feedback.myFeedback]
        }
      };
    ...
    case FEEDBACK_UPDATE_SUCCESS:
      ...
      if (action.data.success) {
        const index = state.feedback.myFeedback.findIndex(
          (v, i) => parseInt(v.id) === parseInt(action.data.data.id)
        );
    ...
    case FEEDBACK_DELETE_SUCCESS:
      ...
      if (action.data.success) {
        const index = state.feedback.myFeedback.findIndex(
          (v, i) => parseInt(v.id) === parseInt(action.data.data)
        );
        deletedFeedback = state.feedback.myFeedback.filter(
          (v, i) => i !== index
        );
      }
      return {
    ...
    case FEEDBACK_ITEM_ADD_SUCCESS:
      return {
        ...
        isAddingFeedbackItem: true,
        isAddedFeedbackItem: false,
        feedbackItem: action.data.success
          ? [action.data.data, ...state.feedbackItem]
          : state.feedbackItem
      };
    ...
    case FEEDBACK_ITEM_UPDATE_SUCCESS:
      ...
      if (action.data.success) {
        const index = state.feedbackItem.findIndex(
          (v, i) => parseInt(v.id) === parseInt(action.data.data.id)
        );
    ...
    case FEEDBACK_ITEM_COMPLETE_REQ_SUCCESS:
      ...
      if (state.feedbackMode) {
        ...
        if (action.data.success) {
          const index = state.feedback.yourFeedback.findIndex(
            (v, i) => parseInt(v.id) === parseInt(action.data.data.id)
          );
    ...
    case FEEDBACK_ITEM_COMMENT_SUCCESS:
      ...
      if (action.data.success) {
        comment = action.data.data
          ? action.data.data.filter((v, i) => !v.deletedAt)
          : [];
    ...
    case FEEDBACK_ITEM_COMMENT_ADD_SUCCESS:
      ...
      return {
        ...
        feedbackComment: action.data.success
          ? [...state.feedbackComment, addedComment]
    ...
    case FEEDBACK_ITEM_COMMENT_UPDATE_SUCCESS:
      ...
      let messages = "";
      if (action.data.success) {
        const index = state.feedbackComment.findIndex(
          (v, i) => parseInt(v.id) === parseInt(action.data.data.id)
        );
    ...
    case FEEDBACK_ITEM_COMMENT_DELETE_SUCCESS:
      ...
      if (action.data.success) {
        const index = state.feedbackComment.findIndex(
          (v, i) => parseInt(v.id) === parseInt(action.data.data.comment_id)
        );
        deleteComment = state.feedbackComment.filter(
          (v, i) => parseInt(i) !== parseInt(index)
        );
