...
const updateSubject = ({updateVisible,handleUpdateCancel,title,category_id}) => {
    ...
    const _onsubmit = useCallback(() => {
        dispath({
            ...
            data:{
                category_color,category_title,category_id
            }
        });
            ...
            <Modal
                ...
                footer={[
                    <div key="add" style={{textAlign:'center'}}>
                        ...
                        <Button key="submit" type="primary" size='large' onClick={_onsubmit} loading={isUpdatingSubject} style={{width:'100%'}}>
                            <strong>주제 수정</strong>
                        </Button>
                    </div>
                ]}
