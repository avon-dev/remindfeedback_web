      ...
      render: ing => (
        <>
          <Group>
            ...
            <Button type="danger" name="reject" id={ing} onClick={_onsubmit}>
              거절
            </Button>
          </Group>
        </>
