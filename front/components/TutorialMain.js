...
const TutorialMain = ({
    ...
    const steps = [
        {   
          ...
          content:<><TutorialFirst firstTitle={firstContentTitle}/></>,
        },
        {
          key:'sub2',
          title: <div style={{fontSize:13}}><strong>{secondTitle}</strong></div>,
          content:<><TutorialSecond secondTitle={secondContentTitle} /></>,
        },
        {
          key:'sub3',
          title: <div style={{fontSize:13}}><strong>{thirdTitle}</strong></div>,
          content:<><TutorialThird thirdTitle={thirdContentTitle}/></>,
        },
        {
          key:'sub4',
          title: <div style={{fontSize:13}}><strong>{fourthTitle}</strong></div>,
          content:<><TutorialForth fourthTitle={fourthContentTitle}/></>,
        },
      ];
                ...
                footer={[
                    ...
                    <div style={{textAlign:'center', marginBottom:5}} >  
                        {current === 1 && (
                            <Collapse bordered={true}  size='large' style={{width:'100%'}} >
                                <Panel disabled={visiblePaner} showArrow={false} header={<strong>{secondSubTitle}</strong>} key="1">
                                    <Input 
                                    ...
                                    <Popconfirm title="이대로 괜찮습니까?" okText="네" cancelText="아니오" onConfirm={secondHandleFunction.bind(this,current)}>
                                        <Button type="danger" key="confirm" style={{width:'100%',marginTop:5}} disabled={visiblePaner}>
                                            <strong>확인</strong>
                                        </Button>
                                    </Popconfirm>
                                </Panel>
                        ...
                        {current === 2 && (
                            <Collapse bordered={true}  size='large' style={{width:'100%'}} >
                                <Panel disabled={visiblePaner} showArrow={false} header={<strong>{thirdSubTitle}</strong>} key="1">
                                    <>
                                    <Input 
                    ...
                    <div style={{textAlign:'center'}}>  
                        {current < steps.length - 1 && (
                            <Button type="primary" onClick={next} size='large' style={{width:'100%'}} disabled={current!==0&&!visiblePaner}>
                                <strong>다음</strong>
                            </Button>
                        )}
                     </div>
